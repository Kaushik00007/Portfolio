    ...
    services.forEach((service, index) => {
      ...
      if (!isLastServiceCard) {
        ...
        const pinTrigger = ScrollTrigger.create({
          ...
          endTrigger: ".experience-header", // End at experience header section
          end: "top 90%", // End when experience header top hits 90% of viewport
        ...
        const scrollAnimation = gsap.to(serviceCardInner, {
          ...
          scrollTrigger: {
            ...
            endTrigger: ".experience-header", // End at experience header
            end: "top 90%", // End when experience header top hits 90%
